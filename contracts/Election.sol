    ...
    contract Election {
        ...
        function addVoterDetails(string memory _username, string memory _email, string memory _password)
        public {
        ...
        function getLoginDetails(address loginAddress) public view returns (string memory, string memory, address){
            return(
